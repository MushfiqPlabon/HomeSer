...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Database indexing information displayed"))
    ...
    def show_index_info(self):
        ...
        self.stdout.write(f"    - Created at index: created_at field indexed")
        self.stdout.write(
            f"    - Composite index: service and created_at fields indexed"
        )
        self.stdout.write(
            f"    - Unique constraint: user and service fields unique together"
        )
